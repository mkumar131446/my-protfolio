...
const Experience = () => {
  return (
    <section id="experience" className="bg-gray-100 py-16 px-6 text-center">
      <h2 className="text-3xl font-bold text-gray-800 mb-10">Experience</h2>
      <div className="max-w-5xl mx-auto grid gap-8 md:grid-cols-2">
        {experience.map((item, i) => (
          <div key={i} className="bg-white shadow p-6 rounded-lg text-left shadow-sm hover:shadow-xl transition">
